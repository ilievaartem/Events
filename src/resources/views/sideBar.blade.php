...
{{--            <use xlink:href="../assets/brand/coreui.svg#signet"></use>--}}
      ...
      <ul class="sidebar-nav" data-coreui="navigation" data-simplebar>
        <li class="nav-item"><a class="nav-link" href="{{route('main')}}">
            <svg class="nav-icon">
        ...
        <li class="nav-item"><a class="nav-link" href="{{route('event.index')}}">
            <svg class="nav-icon">
              <use xlink:href="../icons/sprites/free.svg#cil-bullhorn"></use>
            </svg> Events</a></li>
        ...
        <li class="nav-item"><a class="nav-link" href="charts.html">
            <svg class="nav-icon">
              <use xlink:href="../icons/sprites/free.svg#cil-chart-pie"></use>
            </svg> Charts</a></li>
        <li class="nav-group"><a class="nav-link nav-group-toggle" href="#">
            <svg class="nav-icon">
        ...
        <li class="nav-group"><a class="nav-link nav-group-toggle" href="#">
            <svg class="nav-icon">
              <use xlink:href="../icons/sprites/free.svg#cil-star"></use>
            </svg> Icons</a>
          <ul class="nav-group-items compact">
        ...
        <li class="nav-item"><a class="nav-link" href="widgets.html">
            <svg class="nav-icon">
              <use xlink:href="../icons/sprites/free.svg#cil-calculator"></use>
        ...
        <li class="nav-group"><a class="nav-link nav-group-toggle" href="#">
          ...
          <ul class="nav-group-items compact">
            ...
            <li class="nav-item"><a class="nav-link" href="404.html" target="_top">
                <svg class="nav-icon">
                  <use xlink:href="../icons/sprites/free.svg#cil-bug"></use>
                </svg> Error 404</a></li>
        ...
        <li class="nav-item"><a class="nav-link text-primary fw-semibold" href="https://coreui.io/product/bootstrap-dashboard-template/" target="_top">
            <svg class="nav-icon text-primary">
              <use xlink:href="../icons/sprites/free.svg#cil-layers"></use>
